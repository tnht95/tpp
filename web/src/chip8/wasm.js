...
export class EmuWasm {
    ...
    */
    tick() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.emuwasm_tick(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            if (r1) {
                throw takeObject(r0);
    ...
    */
    get_pc() {
        const ret = wasm.emuwasm_get_pc(this.__wbg_ptr);
        return ret;
    }
    /**
    ...
    */
    key_press(evt, pressed) {
        wasm.emuwasm_key_press(this.__wbg_ptr, addHeapObject(evt), pressed);
    }
    /**
    * @param {number} scale
    */
