...
export const SignInBtn = () => {
  ...
  const loadingBtn = (
    <button
      type="button"
      class="me-2 inline-flex items-center rounded-lg bg-blue-700 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
    >
      <svg
        aria-hidden="true"
        role="status"
  ...
  return <>{isClick() ? loadingBtn : signInBtn}</>;
};
