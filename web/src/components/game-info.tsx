    ...
    <div class="md:flex">
      <div class="w-full mr-4 md:w-3/4">
        <div class="py-6 border-b md:border md:rounded-lg md:px-8">
          ...
          <div class="my-6">
            ...
            <div class="flex">
              <div class="flex mr-2 items-center my-4">
                <div
                  class="flex items-center px-2 leading-none py-1 text-white bg-gray-800 rounded-l-md cursor-pointer">
                  <span class="self-center text-xs font-medium">build</span>
                </div>
                <div
                  class="px-2 text-xs font-semibold text-white leading-none py-1 bg-green-500 rounded-r-md cursor-pointer">passing
                </div>
              </div>
              <div class="flex mr-2 items-center my-4">
                <div
                ...
                <div
                  class="px-2 text-xs font-semibold text-white leading-none py-1 bg-green-500 rounded-r-md cursor-pointer">8.7M
                </div>
              </div>
            </div>
            <hr />
          ...
          <div class="mb-6">
            <div
              class="flex items-center pb-2 -mx-4 text-lg font-bold leading-normal text-transparent hover:text-gray-700">
              <svg class="w-4 h-4 mr-1 cursor-pointer" fill="none" stroke-linecap="round"
            ...
            <hr />
            <div class="my-4">For full documentation, visit <a href="#"
                                                                   class="text-blue-600 hover:underline">tailwindcss.com</a>
            </div>
          </div>
          <div class="mb-6">
            <div
            ...
            <hr />
            <div class="my-4">For help, discussion about best practices, or any other conversation that would
          ...
          <div class="mb-6">
            ...
            <hr />
            <div class="my-4">If you're interested in contributing to Tailwind CSS, please read our <a href="#"
                                                                                                           class="text-blue-600 hover:underline">contributing
              docs</a> <span class="font-semibold text-black">before submitting a pull request.</span></div>
          </div>
        </div>
      </div>
          ...
          <div class="pb-2 mt-4 border-b">
            ...
            <div class="my-4">
              <a class="flex items-center mb-2 text-base font-semibold text-blue-600 hover:underline" href="#">
                <svg class="w-4 h-4 mr-2 text-gray-700" fill="none" stroke-linecap="round"
                     stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                  <path
                    d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1" />
                </svg>
                github.com/tailwindcss</a>
