...
export const UserMenuGroup = () => (
  <div class="flex gap-7 items-center">
    <button id="dropdownNotificationButton" data-dropdown-toggle="dropdownNotification"
      ...
      <div
        class="absolute block w-3 h-3 bg-red-500 border-2 border-white rounded-full left-4 top-1.5 start-2.5" />
    </button>
    ...
    <div id="dropdownAvatarName"
      ...
      <div class=" text-sm text-gray-700 "
        ...
        <div class="py-5 hover:bg-gray-100 flex items-center px-4 gap-2">
          ...
          <a href="/users/d" class=" ">My Page</a>
        </div>
      ...
      <div class="py-5 hover:bg-gray-100 flex text-gray-700 items-center px-4 rounded-b-lg gap-2">
        ...
        <a href="#" class="block  text-sm   ">Sign out</a>
      </div>
    </div>
  </div>
);
